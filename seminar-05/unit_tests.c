...
TEST(string_length)
{
    ...
    SUBTEST(null)
    {
        FAILS_PRECONDITION(string_length(NULL));
    }
...
TEST(string_copy)
{
    ...
    {
        static char buffer[255];
        FAILS_PRECONDITION(string_copy(buffer, NULL));
    }

    SUBTEST(result_null)
    {
        FAILS_PRECONDITION(string_copy(NULL, "Word"));
    }
}
...
TEST(string_count_char)
{
    ...
    SUBTEST(null)
    {
        FAILS_PRECONDITION(string_count_char(NULL, 'A'));
    }
...
TEST(string_edit)
{
    SUBTEST(string_edit_up)
    {
        char string[] = "Hello";
        CHECK(string_edit(&edit_up, string) == string);
        CHECK(strcmp(string, "HELLO") == 0);
    }

    SUBTEST(string_edit_up_numbers)
    {
        char string[] = "123";
        CHECK(string_edit(&edit_up, string) == string);
        CHECK(strcmp(string, "123") == 0);
    }

    SUBTEST(string_edit_up_null_fn)
    {
        char string[] = "123";
        FAILS_PRECONDITION(string_edit(NULL, string));
    }

    SUBTEST(string_edit_up_null_string)
    {
        FAILS_PRECONDITION(string_edit(&edit_up, NULL));
    }
}
...
TEST(string_count_substr)
{
    ...
    SUBTEST(null_string)
    {
        FAILS_PRECONDITION(string_count_substr(NULL, "a"));
    }
    ...
    {
        FAILS_PRECONDITION(string_count_substr("word", NULL));
    }
...
TEST(string_count_string_in_array)
{
    ...
    SUBTEST(null_array)
    {
        FAILS_PRECONDITION(ASSERT_IN(NULL, "hi", 0));
    }

    SUBTEST(non_null_array_and_word_null)
    {
        FAILS_PRECONDITION(ASSERT_IN(strings1, NULL, 0));
    }
    ...
    SUBTEST(empty_array_should_not_contain_anyting)
    {
        ...
        ASSERT_IN(empty, "", 0);
        FAILS_PRECONDITION(ASSERT_IN(empty, NULL, 0));
    }
    SUBTEST(array_with_null_as_first_element_should_behave_as_empty)
    {
        ...
        ASSERT_IN(empty2, "", 0);
        FAILS_PRECONDITION(ASSERT_IN(empty2, NULL, 0));
    }
...
TEST(string_split)
{
    ...
    SUBTEST(original_null)
    {
        ...
        size_t size;
        char delim = ';';
        FAILS_PRECONDITION(string_split(NULL, result, &size, delim));
    }
    ...
    SUBTEST(result_null)
    {
        ...
        size_t size;
        char delim = ';';
        FAILS_PRECONDITION(string_split(original, NULL, &size, delim));
    }
    ...
    SUBTEST(size_null)
    {
        ...
        char result[50][256];
        char delim = ';';
        FAILS_PRECONDITION(string_split(original, result, NULL, delim));
    }
}
